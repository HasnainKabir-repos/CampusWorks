...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8080/api/getcurrentuserID", config)
      .then((response) => {
      ...
      const getConversations = async () => {
        try {
          const res = await axios.get(
            "http://localhost:8080/api/chat/" + currentUser
          );
                ...
                {currentChat ? (
                  <>
                    ...
                    <div className="chatBoxBottom">
                      ...
                      ></textarea>
                      <button
                        className="chatSubmitButton bg-gradient-to-r from-emerald-700 to-cyan-600"
                  ...
                  <span className="noConversationText text-xl font-semibold text-gray-800 ql">

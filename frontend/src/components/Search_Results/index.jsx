...
const Search_Results = () =>{
    ...
    useEffect(() => {
        const getKeywords = async () => {
            try {
                const response = await axios.get('http://localhost:8080/api/jobs/getKeywords');
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex flex-row w-full">
                            ...
                            <div className="w-1/2 flex flex-col items-center justify-center">
                                <div className="mt-8 p-10 w-full rounded-lg shadow-lg bg-emerald-100">
                                    <div class="flex flex-col">
                                        ...
                                        <div className="flex items-center justify-center">
                                           <input type="text" onChange={handleSearch} placeholder="Type here to start searching" class="w-4/5 rounded-md border border-gray-400 px-4 py-2 focus:border-green-600 focus:outline-none focus:ring" />
                                ...
                                {isLoading ? (
                                    <div class="inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-green-600 border-r-transparent align-[-0.125em] text-secondary motion-reduce:animate-[spin_1.5s_linear_infinite]"
                                    role="status">
                                    <span
                                        ...
                                        <div className="w-full px-4">
                                            ...
                                            <div className="bg-white rounded-lg shadow p-4 mb-4" key={job._id}>
                                                ...
                                                <div className="flex items-center justify-center  mt-4">
                                                    ...
                                                    >
                                                    {job.userEmail === currentUser ? "Posted by You" : "Apply Now"}
                                                    </button>
                                                </div>
                            ...
                            <div className="w-full max-w-md mx-auto rounded-md shadow-md overflow-hidden">
                                <div className="px-6 py-4 bg-white">
                                    ...
                                    {freqKeywordsNames.map((keyword) => (
                                        ...
                                        <button onClick={handleKeywordClick} value={keyword} className="text-sm font-medium">{keyword}</button>
                                        </div>
                                    ))}
                                    </div>
                                </div>

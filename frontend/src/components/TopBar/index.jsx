      ...
      <div class="container flex flex-row w-full">
        ...
        <div class="flex align-items-center p-2">
          <button
            ...
            class="relative inline-flex items-center justify-center px-10  overflow-hidden text-sm  transition duration-300 ease-out border-2 border-green-500 rounded-3xl shadow-md group"
          >
            ...
            <span class="absolute flex items-center justify-center w-full h-15 text-grey-700 transition-all duration-300 transform group-hover:translate-x-full ease">
              Log Out
            </span>
